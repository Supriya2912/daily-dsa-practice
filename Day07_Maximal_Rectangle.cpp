...
- For each row:
  - Build histogram heights of consecutive 1s
  - Compute largest rectangle area using stack-based algorithm
...
### Insight
By converting a 2D problem into multiple 1D histogram problems, we can reuse an efficient stack-based solution.
