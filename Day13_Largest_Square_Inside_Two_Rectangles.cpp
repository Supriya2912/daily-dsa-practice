...
### Problem
Given multiple rectangles, find the largest square that can fit inside the intersection of any two rectangles.
...
### Key Insight
A square inside two rectangles must lie within their intersection.
